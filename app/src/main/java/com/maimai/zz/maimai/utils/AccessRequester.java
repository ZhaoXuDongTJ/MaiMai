...
public class AccessRequester {
  ...
  public static AlertDialog.Builder buildLocationAccessDialog(final Activity activity,
    ...
    final String title = resources.getString(com.maimai.zz.maimai.R.string.requesting_location_access);
    final String message = resources.getString(com.maimai.zz.maimai.R.string.do_you_want_to_open_location_settings);
